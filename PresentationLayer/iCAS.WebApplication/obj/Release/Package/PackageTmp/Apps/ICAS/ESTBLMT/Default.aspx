                    ...
                    <ul id="Establishments">
                        ...
                        <li class="Formvalue">
                            <asp:RadioButtonList ID="rbl_EstablishmentTypeCode" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="N" Selected="True">Notice</asp:ListItem>
                                <asp:ListItem Value="T">Tender</asp:ListItem>
                                <asp:ListItem Value="C">Circular</asp:ListItem>
                                <asp:ListItem Value="R">Recent Activities</asp:ListItem>
                            </asp:RadioButtonList>
                        ...
                        <li class="Formlabel">
                            ...
                            <asp:Label ID="lbl_NoticeTitle" runat="server" Text="Enter the Title / Subject: " />
                        </li>
                        <li class="Formvalue">
                            <asp:TextBox ID="txt_NoticeTitle" runat="server" Width="80%" />
                            <%--<ajax:TextBoxWatermarkExtender runat="server" ID="" TargetControlID="" WatermarkText="" WatermarkCssClass="" />--%>
                        ...
                        <li class="Formlabel">
                            <span class="RequiredField">*</span>
                            <asp:Label ID="lbl_Description" runat="server" Text="Notice Description" />
                        </li>
                        <li class="Formvalue">
