    ...
    <asp:UpdatePanel runat="server" ID="updatepanel_StudentAdmMaster">
        <ContentTemplate>
            <ul class="StudentFullWidth">
                <asp:RadioButtonList runat="server" ID="chklist_Details" AutoPostBack="True" RepeatDirection="Horizontal"
                    ...
                    <%--<asp:ListItem Value="4" Enabled="False"> &nbsp; </asp:ListItem>--%>
                </asp:RadioButtonList>
            </ul>
            <asp:MultiView ID="Student_Multi" runat="server">
                ...
                <asp:View ID="View_Grid" runat="server">
                    ...
                    <ul class="StudentFullWidth">
                        ...
                        <li style="width: 100%; display: block; float:left;">
