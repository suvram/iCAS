<%@ Page Title="Send SMS" Language="C#" MasterPageFile="~/App_MasterPages/ICAS-Reports.Master" AutoEventWireup="true" CodeBehind="SendSMS.aspx.cs" Inherits="TCon.iCAS.WebApplication.SendSMS" %>
    ...
    <asp:UpdatePanel runat="server" ID="updatePanel_SendSMS">
        <ContentTemplate>
            <ul id="SMS_UL">
                ...
                <li>
                    <h4>Staffs: <asp:Label runat="server" ID="lblStaffCount" Text="(0)" ForeColor="Blue" /></h4>
