                ...
                <asp:MultiView ID="multiview_Subject" runat="server">
                    <asp:View ID="InputControls" runat="server">
                        <ul>
                           ...
                           <li class="Gview_Subjects">
                                <asp:GridView ID="gridviewCourseSubjects" runat="server" AllowPaging="True" AllowSorting="True"
                                    AutoGenerateColumns="False" CssClass="GridView" Width="98%" 
                                    HorizontalAlign="Left" PageSize="18">
                    ...
                    <asp:View ID="view_Grid" runat="server" onactivate="Page_Load">
                        <ul>
                            ...
                            <li class="Gview_Subjects">
                                <asp:GridView ID="gridview_Subject" runat="server" AllowPaging="True" AllowSorting="True"
                                    AutoGenerateColumns="False" CssClass="GridView" Width="98%" 
