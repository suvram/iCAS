...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMicroERP" runat="server">
	<h1 class="PageTitle">
		<asp:Literal runat="server" ID="lit_PageTitle" Text="Manage Menu Items :-" />
	</h1>
				...
				<asp:View runat="server" ID="view_MenuItemEntry">
					<ul>
						<li class="FormButton_Top">
							...
							<asp:Button runat="server" ID="btn_View" Text="View" CausesValidation="false" OnClick="btn_View_Click" />
						...
						<li class="FormValue">
							<asp:DropDownList runat="server" ID="ddl_SubMenu" AutoPostBack="true" />
						</li>
						<!--Menu DisplayText-->
						<li class="FormLabel">
